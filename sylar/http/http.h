...
public:
	...
	std::string getHead(const std::string& key,const std::string& def = "");
	...
	bool hasHead(const std::string& key,std::string* val = nullptr);
	bool hasParam(const std::string& key,std::string* val = nullptr);
	bool hasCookie(const std::string& key,std::string* val = nullptr);
	
	template<class T>
	bool checkHeaderAs(const std::string& key,T& val,const T& def = T()){
	...
	template<class T>
	bool checkParamAs(const std::string& key,T& val,const T& def = T()){
